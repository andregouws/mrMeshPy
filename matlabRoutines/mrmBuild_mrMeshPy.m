function [msh, unsmoothedMsh] = mrmBuild_mrMeshPy(wm,mmPerVox,smoothFlag,visualizeFlag,varargin)
...
%if ieNotDefined('visualizeFlag'), visualizeFlag = 1; end %AG edit - TODO
...
unsmoothedMsh = meshBuildFromClass_mrMeshPy(wm,mmPerVox);
